classdef cfg
    ...
    properties(Constant = true)
        ...
        NUM_TESTS = 20;                       % Number of random models to generate (and use in differntial testing) ����ģ������ԭ150
        
        NUM_BLOCKS =[150 200];                 % ������Χ
...
%          phases of CyFuzz
        ...
        SL_BLOCKLIBS = {
           struct('name', 'Logic and Bit Operations', 'is_blk', false, 'num', 0.1)
           %struct('name', 'Discrete', 'is_blk', false, 'num', 0.05)
%             struct('name', 'Continuous', 'is_blk', false,  'num', 0.1)
             struct('name', 'Math Operations', 'is_blk', false,  'num', 0.78)
