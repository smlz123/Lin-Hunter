...
% end
% 指定文件夹路径
folderPath = 'E:\FPGA\firstversion\generate\slsf_randgen\slsf\reportsneo';   %存放-pp.slx文件夹的路径
stmp = Get_file_name(folderPath);
stmp = stmp{length(stmp)};
Hdl_folderPath = ['E:\FPGA\firstversion\generate\slsf_randgen\slsf\reportsneo','\',stmp];
Hdl_savePath = ['E:\FPGA\firstversion\generate\slsf_randgen\slsf\reportsneo','\',stmp];
Slx_list = Get_file_name(Hdl_folderPath);
hdl_generate(Slx_list,Hdl_savePath,Hdl_folderPath);
%Hdl_errorpath = ['E:\FPGA\firstversion\generate\slsf_randgen\slsf\reportsneo','\',stmp];
